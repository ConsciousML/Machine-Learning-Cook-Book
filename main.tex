...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machines}
        ...
        \subsubsection{Hard-Margin Support Vector Machines}
            ...
            \begin{align}
                &\max_{\boldsymbol{\sigma}} \: \sum_{i=1}^{N}\sigma_i - \frac{1}{2} \sum_{i=1}^{N}\sum_{j=1}^{N} \sigma_i \sigma_j y_i y_j \boldsymbol{x}_i^\top \boldsymbol{x}_j \\
        ...
        \subsubsection{Soft-Margin Support Vector Machines}
            ...
            \end{align}
            The soft margin penalization makes the model be more flexible and allows for some misclassification just like so:
            \begin{figure}[ht]
                \centering
