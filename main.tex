...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machine}
        A \textbf{kernel function} $\kappa(\boldsymbol{x}, \boldsymbol{x^{'}})$ is a measure of similarity between two objects $\boldsymbol{x}, \boldsymbol{x^{'}} \in \chi$ where $\chi$ is an abstract space. The kernel function is such as:
        \begin{align}
