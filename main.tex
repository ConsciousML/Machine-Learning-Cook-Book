...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machine}
        ...
        As long as there is some higher dimensional space in which $\phi$ is the dot product of that higher dimensional space, then $\kappa(\boldsymbol{x}, \boldsymbol{x}^{'})$ is just the dot product of $\phi$.
