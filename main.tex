...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machines}
        ...
        \subsubsection{Support Vector Classifier}
            ...
            The condition ensures that all samples are on the right side of the hyperplane. Note that this classifier does not allow any misclassification and is known as \textbf{large margin classifier}.
