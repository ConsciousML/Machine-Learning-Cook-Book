...
\chapter{Numerical Computation}
    ...
    \section{Constrained Optimization}
        ...
        The generalized Lagrangian allows us to incorporate the inequality and equality constrains into the objective function resulting in a optimization problem with more relaxed constrains known a the dual problem.
