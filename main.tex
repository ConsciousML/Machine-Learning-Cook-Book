...
\chapter{Numerical Computation}
    ...
    \section{Constrained Optimization}
        ...
        The generalized Lagrangian allows us to incorporate the inequality and equality constrains into the objective function resulting in a optimization problem without explicit constrains known a the dual problem.
        ...
        \end{equation}
        with $\boldsymbol{x^*}$ is an optimal solution of the primal problem.
