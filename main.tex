...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machines}
        \subsubsection{Kernel functions}
            ...
            The \textbf{kernel trick} method stands for calculating the relationship of data in higher dimension without actually transforming the data in this target space. The kernel trick reduces the amount of computation required for kernelized algorithms.
        ...
        \subsubsection{Hard-Margin Support Vector Machines}
            ...
            SVMs try to maximize the margin when separating the data. This fact plays a role in the generalization of SVM models. We can find the value of the margin by computing:
            \begin{align}
        ...
        \subsubsection{Soft-Margin Support Vector Machines}
            \textbf{Soft-margin classifiers} introduce slack variables $\zeta_i \geq 0$ as $\zeta_i = |y_i - f_i|$ where:
            \begin{itemize}
                \item $\zeta_i = 0$ means that the point lies in the correct margin boundary.
