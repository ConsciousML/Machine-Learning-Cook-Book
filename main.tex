...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Support Vector Machines}
        ...
        \subsubsection{Support Vector Classifier}
            ...
            \begin{equation}
                \min_{\boldsymbol{w}, b}\frac{1}{2}||\boldsymbol{w}||^2 \quad \text{s.t} \quad y_i(\boldsymbol{w}^\top \boldsymbol{x}_i + b) \geq 1, i = 1 : N
            \end{equation}
