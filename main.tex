...
\chapter{Numerical Computation}
    ...
    \section{Constrained Optimization}
        ...
        To minimize the Lagrangian introduces the \textbf{dual form} of the problem as:
        \begin{equation}
        ...
        The generalized Lagrangian allows us to incorporate the inequality and equality constrains into the objective function resulting in a optimization problem with more relaxed constrains known a the dual problem. Because the dual problem is a lower bound of the primal problem, we try to find the maximum lower bound such as:
        \begin{equation}
...
\chapter{Machine Learning Concepts}
    ...
    \subsection{Kernel Methods}
        ...
        \subsubsection{Support Vector Machines}
            ...
            \begin{equation}
                \min_{\boldsymbol{w}, b}\frac{1}{2}||\boldsymbol{w}||^2 \quad \text{s.t} \quad y_i(\boldsymbol{w}_i^\top \boldsymbol{x} + b) \geq 1, i = 1 : N
            \end{equation}
